                ...
                var process = function process(
                  ...
                  if (!settings.sendBeaconCommit) {
                    ...
                    if (Object.keys(settings.xhrHeaders).length) {
                      Object.keys(settings.xhrHeaders).forEach(function (
                        header
                      ) {
      ...
      /***/ function (
        ...
        var Scorm2004API = /*#__PURE__*/ (function (_BaseAPI) {
          ...
          function Scorm2004API(settings) {
            ...
            _this.adl =
              new _cmi_scorm2004_cmi__WEBPACK_IMPORTED_MODULE_1__.ADL(); // Rename functions to match 2004 Spec and expose to modules
